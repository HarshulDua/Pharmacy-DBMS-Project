...
EXEC Insert_Contract(3, 'MediZone', 'HealthPlus', 'Mohit Rana', 'Antibiotic distribution', TO_DATE('2024-06-01','YYYY-MM-DD'), TO_DATE('2026-06-01','YYYY-MM-DD'));
EXEC Insert_Contract(4, 'TrustMeds', 'BioZen', 'Deepa Joshi', 'Neurology and skin meds', TO_DATE('2023-11-20','YYYY-MM-DD'), TO_DATE('2025-11-19','YYYY-MM-DD'));
